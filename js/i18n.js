...
const DICT = {
  en: {
    ...
    practiceDone: 'Practice done', alreadyKnow: 'I already know this', needsMorePractice: 'Needs more practice',
    ...
    answerHere: 'Build your answer here', clear: 'Clear', check: 'Check', correct: 'Correct. Great work.', wrong: 'Try again. Build from left to right.',
  ...
  id: {
    ...
    practiceDone: 'Latihan selesai', alreadyKnow: 'Saya sudah tahu', needsMorePractice: 'Perlu latihan lagi',
    ...
    answerHere: 'Susun jawaban di sini', clear: 'Hapus', check: 'Periksa', correct: 'Benar. Bagus sekali.', wrong: 'Coba lagi. Susun dari kiri ke kanan.',
